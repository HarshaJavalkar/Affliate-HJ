...
export class DataService {
  ...
  getAllaffliateProductstoUsers(): Observable<any> {
  ...
  createAffliate(productObj): Observable<any> {
    return this.hc.post('/product/createaffliate', productObj);
  }
  c_items(username): Observable<any> {
    return this.hc.get(`admin/getCarousel/${username}`);
  }
  verifyRequestAdmin(email): Observable<any> {
